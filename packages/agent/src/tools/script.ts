// packages/agent/src/tools/script.ts
import type { AgentResult } from "../types.js";

// callable signature expected by registry/executor
type ToolLike = (input: { goal?: string; suite?: string }) => Promise<AgentResult>;
type ScriptInput = { goal?: string; suite?: string };

export function scriptTool(): ToolLike {
  return async ({ goal, suite }: ScriptInput): Promise<AgentResult> => {
...
test('${suite || "HyperTest generated: smoke"}', async ({ page }) => {
