...
hoistedDependencies:
  ...
  esutils@2.0.3:
    esutils: private
  examples/basic-web-flow:
    '@hypertest/example-basic-web-flow': private
  ...
  packages/agent:
    '@hypertest/agent': private
  packages/cli:
    '@hypertest/cli': private
  packages/core:
    '@hypertest/core': private
  packages/orchestrator:
    '@hypertest/orchestrator': private
  packages/runner-web:
    '@hypertest/runner-web': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Fri, 03 Oct 2025 03:40:14 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-gnu@4.52.3'
  - '@rollup/rollup-win32-x64-msvc@4.52.3'
storeDir: /Users/jaineshpanchal/Library/pnpm/store/v3
